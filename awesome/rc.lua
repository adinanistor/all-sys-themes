...
local gui_editor   = "sublime"
local browser      = "firefox"
local file         = "thunar"

awful.util.terminal = terminal
awful.util.tagnames = { "new", "web", "dev", "office", "media" }
...
globalkeys = awful.util.table.join(
    ...
    -- awful.key({ "Shift" }, "Left", function () lain.util.tag_view_nonempty(-1) end,
              -- {description = "view  previous nonempty", group = "tag"}),
    -- awful.key({ "Shift" }, "Right", function () lain.util.tag_view_nonempty(1) end,
              -- {description = "view  previous nonempty", group = "tag"}),
    ...
    awful.key({ modkey }, "f", function () awful.spawn(file) end),
